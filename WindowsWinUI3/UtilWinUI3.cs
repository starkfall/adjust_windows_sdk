...
namespace AdjustSdk.WinUI3
{
    public class UtilWinUI3
    {
        ...
        public static Task RunInForeground(Microsoft.UI.Dispatching.DispatcherQueue dispatcher, Action action, Task previousTask = null)
        {
        ...
        public static Task RunInForeground(Microsoft.UI.Dispatching.DispatcherQueue dispatcher, Action action)
        {
            if (dispatcher != null)
            {
                var result = dispatcher.TryEnqueue(() => action());
                if (result)
                {
